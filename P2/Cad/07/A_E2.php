...
$Valida = $_GET['Sec'];  
  ...
  $empregador = "01+EE+000+1]05734665000142]]TESTE VELTI]CURITIBA";
    ...
    elseif ($Valida == '188') {
      ...
      if(@$_POST["enviaEmpregador"]){
       ...
       if ($msg1 == "01+EE+00") {
        ...
        echo '<a class="btn btn-success btn-block" href="A_E3.php?Sec=998"><iclass="icon-ok icon-white" >Próximo passo</a> <br /><br />';
        echo '</div>';
