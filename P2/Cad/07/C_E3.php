  ...
  <div class="content-wrapper">
   <div class="container">
    <section class="content-header">
     <ol class="breadcrumb">
      <li>CADASTRO DE EQUIPAMENTO: VELTI C</li>
      <li><code>BIOMETRIA + BARRAS (<strong>RFID)</strong></code></li>
     </ol>
    </section>
    <?php
    if ($Valida <> '219') {
    ...
    elseif ($Valida == '219') {
      ...
      <div class='col-xs-3'>
       ...
       <strong><code>01</code></strong><br />
       <strong><code>02</code></strong>
      </div>
      <div class='col-xs-3'>
       COLABORADOR 2:<br />
       NUM. PIS:<br />
      ...
      <div class='col-xs-3'>
       ...
       <strong><code>03</code></strong><br />
       <strong><code>04</code></strong>
      </div>
          ...
          <?php
          if(@$_POST["EnviaW"]){
           $cod_msg = "03+EU+00+2+I[900000000023[TESTE DE FABRICA[0[2[1}2]I[900000000029[TESTE DE FABRICA 2[0[2[3}4";
           ...
           if ($msg1 == "03+EU+00") {
            echo '<script type="text/JavaScript">alert("Cartão Cadastrado!");location.href="C_E4.php?Sec=412"</script>';
           }
