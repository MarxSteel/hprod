  ...
  <div class="content-wrapper">
   <div class="container">
    <section class="content-header">
     <ol class="breadcrumb">
      <li>CADASTRO DE EQUIPAMENTO: ORION 6B</li>
      <li><code>BIOMETRIA / BARRAS</code></li>
     </ol>
    </section>
    <section class="content">
     ...
     <div class="box-body">
       ...
       <table width="400" border="0" align="center">
        <tr>
         <div class="col-xs-5">PREFIXO (MODELO)
          <input class="form-control" disabled="disabled" TYPE="text" VALUE="0000400800">
         </div>
      ...
      if(@$_POST["enviar"]){
       ...
       $executa = $PDO->query("INSERT INTO cadastro_1510 (Modelo, NumREP, DataCadastro, HoraCadastro, Status, Observa, UserCadastro, HOS, LBio, LBar) VALUES ('ORION 6B', '$numFabrica', '$data', '$hora', '1', '$Obseracao', '$Nick', '$HOS', '$Bio', '11')");
        if($executa)
        {
