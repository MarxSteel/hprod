  ...
  <div class="content-wrapper">
   <div class="container">
    <section class="content-header">
     <ol class="breadcrumb">
      <li>CADASTRO DE EQUIPAMENTO: PRISMA F</li>
      <li><code>D. ALFANUMÉRICO 16X2 | BIOMETRIA + PROXIMIDADE + BARRAS</code></li>
     </ol>
    </section>
    ...
    <div class="box box-default">
     ...
     <div class="box-body">
      <div class="span12">
       ...
       <a class="btn btn-success btn-block btn-flat" href="F_E2.php?Sec=33"><iclass="icon-ok icon-white" >Próximo passo</a>
       <br /><br />
      </div>
     </div>
    </div>
