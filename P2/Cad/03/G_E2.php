  ...
  <div class="content-wrapper">
   <div class="container">
    <section class="content-header">
     <ol class="breadcrumb">
      <li>CADASTRO DE EQUIPAMENTO: PRISMA G</li>
      <li><code>D. ALFANUMÉRICO 16X2 | PROXIMIDADE HID</code></li>
     </ol>
    </section>
    <?php
    if ($Valida <> '22') {
    ...
    elseif ($Valida == '22') {
      ...
      if(@$_POST["enviaEmpregador"]){
       ...
       if ($msg1 == "01+EE+00") {
        ...
        echo '<a class="btn btn-success btn-block" href="G_E3.php?Sec=199"><iclass="icon-ok icon-white" >Próximo passo</a> <br /><br />';
        echo '</div>';
