        ...
        <div class="modal-content">
         ...
         <div class="modal-body">
          ...
          if(@$_POST["EnviaW"]){
           ...
           if ($msg1 == "03+EU+00") {
            echo '<script type="text/JavaScript">alert("Cartão Cadastrado!");location.href="I_E4.php?Sec=11"</script>';
           }
        ...
        <div class="modal-content">
         ...
         <div class="modal-body">
          ...
          if(@$_POST["EnviaA"]){
           ...
           elseif ($msg1 <> "03+EU+00") {
            echo '<script type="text/JavaScript">alert("Cartão Cadastrado!");location.href="I_E4.php?Sec=145"</script>';
           }
          }
          ?>
         </div>
