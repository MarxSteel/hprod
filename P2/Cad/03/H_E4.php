  ...
  <div class="content-wrapper">
   <div class="container">
    <section class="content-header">
     <ol class="breadcrumb">
      <li>CADASTRO DE EQUIPAMENTO: PRISMA H</li>
      <li><code>D. ALFANUMÉRICO 16X2 | BARRAS + PROXIMIDADE</code></li>
     </ol>
    </section>
    <?php
    if ($Valida <> '11') {
     ...
     <div class="box-body">
      <form name="cadastrar_anuncio" id="name" method="post" action="" enctype="multipart/form-data">
         <div class="col-xs-5">PREFIXO (MODELO)
          <input class="form-control" disabled="disabled" TYPE="text" VALUE="0000400163">
         </div>
      ...
      if(@$_POST["enviar"]){
       ...
       $executa = $PDO->query("INSERT INTO cadastro_1510 (Modelo, NumREP, DataCadastro, HoraCadastro, Status, Observa, UserCadastro, HOS, LBar, LProx) VALUES ('Prisma H', '$numFabrica', '$data', '$hora', '1', '$Obseracao', '$Nick', '$HOS', '9', '$Prox')");
        if($executa)
        {
