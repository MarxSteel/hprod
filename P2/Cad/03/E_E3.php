   ...
   <div class="container">
    ...
    elseif ($Valida == '1357') {
      ...
      ?>
          ...
          <div class='col-xs-8'>
            TESTE DE FABRICA 01<br />
           <strong><code>900000000023</code></strong><br />
      ...
      <div class="col-xs-12"><BR />
          <form name="enviaWiegand" id="EnviaWiegand" method="post" action="" enctype="multipart/form-data">
           <div class='col-xs-12'><br /><br />
            <input name="EnviaW" type="submit" class="btn btn-danger btn-block btn-lg" id="EnviaW" value="ENVIAR REFERENCIA DO BARRAS" />
           </div>
          </form>
          <?php
          if(@$_POST["EnviaW"]){
           ...
           if ($msg1 == "03+EU+00") {
            echo '<script type="text/JavaScript">alert("Cartão Cadastrado!");location.href="E_E4.php?Sec=1122"</script>';
           }
