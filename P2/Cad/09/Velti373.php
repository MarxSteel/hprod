  ...
  <div class="content-wrapper">
   <div class="container">
    <section class="content-header">
     <ol class="breadcrumb">
      <li>CADASTRO DE EQUIPAMENTO: VELTI 373</li>
     </ol>
    </section>
     ...
     <div class="box box-default">
      ...
      <form name="cadastrar_anuncio" id="name" method="post" action="" enctype="multipart/form-data">
         <div class="col-xs-4">Modelo
          <input class="form-control" disabled="disabled" TYPE="text" VALUE="Velti 373">
         </div>
      ...
      if(@$_POST["enviar"]){
       ...
       $executa = $PDO->query("INSERT INTO cadastro_373 (Modelo, NumSerie, DataCadastro, HoraCadastro, Status, UserCadastro, LeiMifare, LeiProx, LeiBarras, LeiBio, Firmware, Display, Observa) VALUES ('Velti 373', '$NumREP', '$data', '$hora', '1', '$Nick', '$Smart', '$Prox', '$Barras', '$Bio', '$Firmware', '$Display', '$Observacao')");
        if($executa)
        {
