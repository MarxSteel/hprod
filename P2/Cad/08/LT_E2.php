           ...
           <h3 class="page-title">Cadastrar Empregador</h3>
            ...
            if(@$_POST["enviar"])
            {
             ...
             if ($msg1 == "01+EE+00") 
             {
              ...
              echo '<a class="btn btn-success btn-block btn-flat" href="BIO-PROX_E3.php?Sec=45"><iclass="icon-ok icon-white" >Próximo passo</a> <br /><br />';
              echo '</div>';
             }
             else if ($msg1 <> "01+EE+00") 
             {
              ...
              echo '<h4><i class="icon fa fa-ban"></i> Atenção!</h4>';
              echo 'EMPREGADOR ENVIADO, RESPOSTA DO RELÓGIO:<strong>' . $msg1 . '</strong>.';
              echo '<a class="btn btn-success btn-block btn-flat" href="LT_E3.php?Sec=45"><iclass="icon-ok icon-white" >Próximo passo</a> <br /><br />';
              echo '</div>';
             } 
            }
            ?>
