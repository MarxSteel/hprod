  ...
  <div class="content-wrapper">
   <div class="container">
    <section class="content-header">
     <ol class="breadcrumb">
      <li>CADASTRO DE EQUIPAMENTO: PRIMME ACESSO SF</li>
     </ol>
    </section>
     ...
     <div class="box box-default">
      ...
      <form name="cadastrar_anuncio" id="name" method="post" action="" enctype="multipart/form-data">
         <div class="col-xs-4">Modelo
          <input class="form-control" disabled="disabled" TYPE="text" VALUE="Primme Acesso SF">
         </div>
      ...
      if(@$_POST["enviar"]){
       ...
       $executa = $PDO->query("INSERT INTO cadastro_acesso (Modelo, NumSerie, DataCadastro, HoraCadastro, Status, UserCadastro, LeiMifare, LeiProx, LeiBarras, LeiBio, Firmware, Display, Observa) VALUES ('Primme Acesso SF', '$NumREP', '$data', '$hora', '1', '$Nick', '$Smart', '$Prox', '$Barras', '$Bio', '$Firmware', '$Display', '$Observacao')");
        if($executa)
        {
