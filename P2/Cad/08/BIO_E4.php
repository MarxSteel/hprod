  ...
  <div class="content-wrapper">
   <div class="container">
    ...
    if ($Valida <> '1337') {
      ...
      echo '<h2 class="box-title"><strong> PASSO 4: </strong>FINALIZAR CADASTRO</h2>';
      echo '</div>';
     ...
     <div class="box-body">
      <form name="cadastrar_anuncio" id="name" method="post" action="" enctype="multipart/form-data">
       <div class="col-xs-5">PREFIXO (MODELO)
        <input class="form-control" disabled="disabled" TYPE="text" VALUE="0003800215">
       </div>
      ...
      if(@$_POST["enviar"])
      {
       ...
       $executa = $PDO->query("INSERT INTO cadastro_1510 (Modelo, NumREP, DataCadastro, HoraCadastro, Status, Observa, UserCadastro, HOS, LBio) VALUES ('IDNOX BIO', '$numFabrica', '$data', '$hora', '1', '$Obseracao', '$Nick', '$HOS', '$bio')");
        if($executa)
        {
