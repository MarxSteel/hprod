  ...
  <div class="content-wrapper">
   <div class="container">
    <section class="content-header">
     <ol class="breadcrumb">
      <li>CADASTRO DE EQUIPAMENTO: IDNOX SMART-PROX</li>
      <li><code>PROXIMIDADE + SMART CARD</code></li>
     </ol>
    </section>
    <?php
    if ($Valida <> '191') {
     ...
     <div class="box-body">
      <form name="cadastrar_anuncio" id="name" method="post" action="" enctype="multipart/form-data">
       <div class="col-xs-5">PREFIXO (MODELO)
        <input class="form-control" disabled="disabled" TYPE="text" VALUE="0003800214">
       </div>
      ...
      if(@$_POST["enviar"])
      {
       ...
       $executa = $PDO->query("INSERT INTO cadastro_1510 (Modelo, NumREP, DataCadastro, HoraCadastro, Status, Observa, UserCadastro, HOS, LMif, LBio) VALUES ('IDNOX LT SMART-PROX', '$numFabrica', '$data', '$hora', '1', '$Obseracao', '$Nick', '$HOS', '9  ', '$bio')");
        if($executa)
        {
