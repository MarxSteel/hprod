  ...
  <div class="content-wrapper">
   <div class="container">
    <section class="content-header">
     <ol class="breadcrumb">
      <li>CADASTRO DE EQUIPAMENTO: ONIX 1</li>
      <li><code>BIOMETRIA / PROXIMIDADE (RFID)</code></li>
     </ol>
    </section>
    <section class="content">
     ...
     <div class="box-body">
      ...
      if(@$_POST["enviar"]){
       ...
       $executa = $PDO->query("INSERT INTO cadastro_1510 (Modelo, NumREP, DataCadastro, HoraCadastro, Status, Observa, UserCadastro, HOS, LBio, LProx) VALUES ('Onix 1', '$numFabrica', '$data', '$hora', '1', '$Obseracao', '$Nick', '$HOS', '$Bio', '$Prox')");
        if($executa)
        {
