  ...
  <div class="content-wrapper">
   <div class="container">
    <section class="content-header">
     <ol class="breadcrumb">
      <li>CADASTRO DE EQUIPAMENTO: PRISMA SUPER FÁCIL R01</li>
      <li><code>D. GRÁFICO | BIOMETRIA + PROXIMIDADE + BARRAS + MIFARE</code></li>
     </ol>
    </section>
    <?php
    if ($Valida <> '1') {
    ...
    elseif ($Valida == '1') {
      ...
      if(@$_POST["enviaEmpregador"]){
       ...
       if ($msg1 == "01+EE+00") {
        ...
        echo '<a class="btn btn-success btn-block" href="R01_E3.php?Sec=1"><iclass="icon-ok icon-white" >Próximo passo</a> <br /><br />';
        echo '</div>';
