  ...
  <div class="content-wrapper">
   <div class="container">
    <section class="content-header">
     <ol class="breadcrumb">
      <li>CADASTRO DE EQUIPAMENTO: HEXA A</li>
    ...
    <section class="content">
     ...
     <div class="box-body">
       ...
       <table width="400" border="0" align="center">
        <tr>
         <div class="col-xs-5">PREFIXO (MODELO)
          <input class="form-control" disabled="disabled" TYPE="text" VALUE="0000400250">
         </div>
      ...
      if(@$_POST["enviar"]){
       ...
       $executa = $PDO->query("INSERT INTO cadastro_1510 (Modelo, NumREP, DataCadastro, HoraCadastro, Status, Observa, UserCadastro, HOS, LBio, LProx, LMif, LBar) VALUES ('HEXA A', '$numFabrica', '$data', '$hora', '1', '$Obseracao', '$Nick', '$HOS', '$Bio', '$Prox', '9', '9')");
        if($executa)
        {
