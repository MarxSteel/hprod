     ...
     <div class="col-xs-12"> 
      ...
      <form name="D373" id="name" method="post" action="" enctype="multipart/form-data">
       ...
       <div class="col-xs-12"><br />
        <input name="D373" type="submit" class="btn btn-danger btn-lg btn-block"  value="REPROVAR EQUIPAMENTO"  />
       </div>
      </form>
       <?php 
        if(@$_POST["D373"])
        {
         ...
         $executa = $PDO->query("UPDATE cadastro_373 SET Status='2', Observa='$Atual', DataRetorna='$DataLiberar' WHERE NumSerie='$NumeroREP' ");
         if($executa)
         {
