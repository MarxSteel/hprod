     ...
     <div class="col-xs-12"> 
      ...
      <form name="AACESSO" id="name" method="post" action="" enctype="multipart/form-data">
       ...
       <div class="col-xs-12"><br />
        <input name="AACESSO" type="submit" class="btn btn-danger btn-lg btn-block"  value="REPROVAR EQUIPAMENTO"  />
       </div>
      </form>
       <?php 
        if(@$_POST["AACESSO"])
        {
         ...
         $At = "<br /><strong>Nova Atualização:</strong> Equipamento Reprovado";
         ...
         $executa = $PDO->query("UPDATE cadastro_acesso SET Status='2', DataRetorna='$DataHoje', Observa='$Atual' WHERE NumSerie='$NumeroREP' ");
         if($executa)
         {
