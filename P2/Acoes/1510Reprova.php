      ...
      <div class="col-xs-12"><br /></div>
       ...
       <?php 
        if(@$_POST["D1510"])
        {
         ...
         $executa = $PDO->query("UPDATE cadastro_1510 SET Status='2', DataRetorna='$DataHoje', Observa='$Atual' WHERE NumREP='$NumeroREP' ");
         if($executa)
         {
         echo '<script type="text/javascript">alert("Equipamento Reprovado!!");</script>';
