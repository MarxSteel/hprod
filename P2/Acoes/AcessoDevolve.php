     ...
     <div class="col-xs-12"> 
      ...
      <form name="AACESSO" id="name" method="post" action="" enctype="multipart/form-data">
       ...
       <div class="col-xs-12"><br />
        <input name="AACESSO" type="submit" class="btn btn-danger btn-lg btn-block"  value="DEVOLVER EQUIPAMENTO"  />
       </div>
      </form>
       <?php 
        if(@$_POST["AACESSO"])
        {
         ...
         $executa = $PDO->query("UPDATE cadastro_acesso SET Status='1', Observa='$Atual' WHERE NumSerie='$NumeroREP' ");
         if($executa)
         {
