     ...
     <div class="col-xs-12"> 
      ...
      <div class="col-xs-12"><br /></div>
       ...
       <div class="col-xs-12"><br />
        <input name="D1510" type="submit" class="btn btn-success btn-lg btn-block" id="D1510" value="LIBERAR EQUIPAMENTO"  />
       </div>
      </form>
       <?php 
        if(@$_POST["D1510"])
        {
         ...
         $executa = $PDO->query("UPDATE cadastro_1510 SET Status='3', DataLiberaReteste='$DataHoje', Observa='$Atual', UserReteste='$NomeUserLogado' WHERE NumREP='$NumeroREP' ");
         if($executa)
         {
         echo '<script type="text/javascript">alert("Equipamento Liberado com Sucesso!!");</script>';
