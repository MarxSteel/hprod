      ...
      <div class="col-xs-12"><br />
       ...
       <?php
        if(@$_POST["recebeItem"])
        {
         ...
         $Recebe = $PDO->query("UPDATE login SET senha='$passwd' WHERE codLogin='$id'");
         if ($Recebe)
          {
          $Ev = "Senha Trocada";
        $InsLog = $PDO->query("INSERT INTO loglaudo (Evento, UserEvento, EventoID, DataCadastro) VALUES ('$Ev', '$NomeUserLogado', '5', '$DataRecebe')"); 
        if ($InsLog) 
        {
